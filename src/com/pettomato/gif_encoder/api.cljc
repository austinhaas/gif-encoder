(ns com.pettomato.gif-encoder.api
  (:require
   [com.pettomato.gif-encoder :refer :all]))
...
(defn instantiate-gif-with-global-color-table [gif]
  (let [{:keys [width height frames background-color loop? color-bits-per-channel]} gif
        ...
        size-of-global-color-table (calc-size-of-color-table (dec (count global-color-table)))
        padding                    (- (size-of-color-table->actual-size size-of-global-color-table)
                                      (count global-color-table))
        padded-color-table         (concat global-color-table (repeat padding 0))
        color-resolution           (calc-color-resolution color-bits-per-channel)
        background-color-index     (if background-color
                                     (.indexOf global-color-table background-color)
                                     0)
        logical-screen (in logical-screen
                           :logical-screen-descriptor (in logical-screen-descriptor
                           ...
                           :global-color-table        (in color-table :rgbs padded-color-table))
        data (apply concat
                    (if loop?
                      (in netscape-looping-application-extension)
                      [])
                    (for [f frames]
                      (let [{:keys [image left top delay-time]} f
                            ...
                            lzw-minimum-code-size (calc-lzw-minimum-code-size size-of-global-color-table)
                            img-data              (table-image->data lzw-minimum-code-size tabled-img)]
                        (in graphic-block
                            :graphic-control-extension (in graphic-control-extension :delay-time delay-time)
                            :graphic-rendering-block   (in graphic-rendering-block
                                                           :table-based-image (in table-based-image
                                                                                  :image-descriptor (in image-descriptor
                                                                                  ...
                                                                                  :image-data       (in table-based-image-data
                                                                                                        :lzw-minimum-code-size lzw-minimum-code-size
                                                                                                        :image-data            img-data
                                                                                                        :image-data-terminator (in image-data :size 0 :data []))))))))]
    (in gif-data-stream
        :header         header
        ...
        data             (apply concat
                                ...
                                (for [f frames]
                                  (let [{:keys [image left top delay-time]} f
                                        ...
                                        size-of-local-color-table  (calc-size-of-color-table (dec (count local-color-table)))
                                        padding                    (- (size-of-color-table->actual-size size-of-local-color-table)
                                        ...
                                        lzw-minimum-code-size      (calc-lzw-minimum-code-size size-of-local-color-table)
                                        img-data                   (table-image->data lzw-minimum-code-size tabled-img)]
                                    (in graphic-block
                                        :graphic-control-extension (in graphic-control-extension :delay-time delay-time)
                                        :graphic-rendering-block   (in graphic-rendering-block
                                                                       :table-based-image (in table-based-image
                                                                                              ...
                                                                                              :local-color-table (in color-table
